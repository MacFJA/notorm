...
use NotORM\Structure\Convention;
use PDO;
 ...
 */
class NotORM extends AbstractBase
{
     ...
     * @param Structure $structure or null for new Convention
     * @param Cache     $cache     or null for no cache
     */
