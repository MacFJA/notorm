 ...
 */
class Row extends AbstractBase implements \IteratorAggregate, \ArrayAccess, \Countable, JsonSerializable
{
    ...
    function __get($name)
    {
        ...
        if (!isset($referenced)) {
            ...
            if ($keys) {
                ...
                $referenced->where(
                    $table . '.' . $this->result->notORM->structure->getPrimary($table),
                    array_keys($keys)
                );
            } else {
                $referenced = array();
    ...
    function __call($name, array $args)
    {
        ...
        $return->where(
            $table . '.' . $column,
            array_keys((array)$this->result->rows)
